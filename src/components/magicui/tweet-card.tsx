...
export const TweetSkeleton = ({
  ...
  <div
    className={cn(
      "flex h-full max-h-max w-full min-w-[18rem] flex-col gap-2 rounded-lg border bg-slate-400 p-4",
      className,
    )}
    {...props}
  >
      ...
      <div>
        ...
        <div className="flex items-center space-x-1">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-sm text-white transition-all duration-75"
          >
...
export const TweetBody = ({ tweet }: { tweet: EnrichedTweet }) => (
  <div className="break-words leading-normal tracking-tighter text-white">
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-full w-full max-w-[32rem] border-white/20 bg-zinc-800 flex-col gap-2 overflow-hidden rounded-lg border p-4 backdrop-blur-md",
        className,
      )}
      {...props}
    >
